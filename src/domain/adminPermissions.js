...
export const ADMIN_PERMISSION = {
    ...
    RECORD_CRYPTO_TRANSFER: "record_crypto_transfer",
    RECONCILE_DEPOSIT: "reconcile_deposit",
};
...
export const ROLE_PERMISSIONS = Object.freeze({
    [ADMIN_ROLE.ORDER_REVIEWER]: [
        ADMIN_PERMISSION.VIEW_ORDER_QUEUE,
        ADMIN_PERMISSION.DECIDE_ORDER_APPROVAL,
        ADMIN_PERMISSION.EXECUTE_PURCHASE,
        ADMIN_PERMISSION.RECORD_CRYPTO_TRANSFER,
        ADMIN_PERMISSION.RECONCILE_DEPOSIT,
    ],
