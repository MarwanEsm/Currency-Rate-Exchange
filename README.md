...
- `pages/admin/orders.jsx` + `GET /api/fiat-to-crypto/admin/queue` + `GET /api/fiat-to-crypto/admin/decisions/log` + `POST /api/fiat-to-crypto/admin/orders/[id]/decision`: admin review queue with approve/reject + audit trail (FCX-43, FCX-26).
